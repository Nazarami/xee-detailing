<script>
	...
	const commitmentText =
		'Xeedetailing is committed to getting the job done, especially when it comes to their packages. You can count on us to be professional, timely, efficient and make sure you’re satisfied every step of the way.';
</script>

<main class="flex-1 bg-black text-white">
	<Image src="main-images/image-0.jpeg" />
